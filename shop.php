...
<main>
    ...
    <div style="margin-bottom: 50px">
        <div class="w3-row-padding product-container" style="margin: 0 auto;">
            ...
            <div class="w3-card w3-third w3-center w3-padding-32 product">
                <img src="photos/shop_photos/fourplayer_cabinet.png" alt="Quattro Giocatori"> <br>
                <h3>Quattro Giocatori</h3>
                <h5>A partire da 700€</h5>
                <button class="w3-btn w3-green" onclick="addedToCart(event)">Aggiungi al carrello</button>
            </div>
            <div class="w3-card w3-third w3-center w3-padding-32 product">
                <img src="photos/shop_photos/classic_cabinet.png" alt="Classico"> <br>
                <h3>Classico</h3>
        ...
        <div class="w3-row-padding product-container" style="margin: 20px auto;">
            <div class="w3-card w3-third w3-center w3-padding-32 product">
                <img src="photos/shop_photos/wallmounted_cabinet.png" alt="A Muro"> <br>
                <h3>A muro</h3>
                <h5>A partire da 500€</h5>
                <button class="w3-btn w3-green" onclick="addedToCart(event)">Aggiungi al carrello</button>
            </div>
            <div class="w3-card w3-third w3-center w3-padding-32 product">
                <img src="photos/shop_photos/racing_cabinet.png" alt="Racing"> <br>
                <h3>Racing</h3>
